<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Herramientas_AnalisisGraficoOperaciones" Codebehind="AnalisisGraficoOperaciones.aspx.vb" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="Herramientas" style="margin-bottom: 10px; float: left">
            <radarcube:TOLAPToolbox ID="BarraHerramienta" runat="server" ExportID="Exportar" GridID="Grid">
                <SaveLayoutButton Tooltip="Guardar diseño actual" FileName="GraficoOperaciones"></SaveLayoutButton>
                ...
                <ExportJPEGButton Tooltip="Exportar vista a formato {0} " FileName="GraficoOperaciones"></ExportJPEGButton>

                <ExportCSVButton Tooltip="Exportar vista a formato {0} " FileName="GraficoOperaciones"></ExportCSVButton>

                <ExportXLSButton Tooltip="Exportar vista a formato {0} " FileName="GraficoOperaciones"></ExportXLSButton>

                <ExportHTMLButton Tooltip="Exportar vista a formato {0} " FileName="GraficoOperaciones"></ExportHTMLButton>

                <ExportPDFButton Tooltip="Exportar vista a formato {0} " FileName="GraficoOperaciones"></ExportPDFButton>
        ...
        <div>
            <cc1:TOLAPCube ID="Cubo" runat="server" CubeGuid="" DataSourceID="SqlInstrumento" FactTableName="DefaultView">
                <Measures>
                    ...
                    <radarcube:TCubeMeasure DataTable="DefaultView" DisplayName="Yield" SourceField="yield" SourceFieldType="System.Double" UniqueName="97a687c9-815b-47ef-bcf9-7b5af58e008c" />
                ...
                <Dimensions>
                    ...
                    <radarcube:TCubeDimension DisplayName="Operaciones" UniqueName="[Operaciones]">
                        <Hierarchies>
                            ...
                            <radarcube:TCubeHierarchy DataTable="DefaultView" DiscretizationBucketFormat="%{First} - %{Last}" DisplayField="mercado" DisplayFieldType="System.String" DisplayName="Mercado" Origin="hoAttribute" TotalCaption="Total" TypeOfMembers="htStrings" UniqueName="[Operaciones].[mercado]" UnknownMemberName="Unknown">
                            </radarcube:TCubeHierarchy>
                        </Hierarchies>
                    </radarcube:TCubeDimension>
                </Dimensions>
                <CubeTablePositions>
                    <cc1:TCubeTablePosition Name="DefaultView" Position="216, 82" />
                </CubeTablePositions>
            </cc1:TOLAPCube>
        </div>
