                ...
                <telerik:RadPageView ID="RadPageView1" runat="server" Width="922px" TabIndex="1">
                    <table class="style1">
                        ...
                        <tr>
                            ...
                            <td class="style3">
                                <asp:RequiredFieldValidator ID="ValidatorFechaPuestoBolsa" runat="server"
                                    ControlToValidate="txtFechaConstitucion" ErrorMessage="Fecha" Font-Size="Small"
                                    ForeColor="Red" SetFocusOnError="True"
                                    ToolTip="Debe ingresar un nombre válido." Width="70px">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="style8">
                                <telerik:RadComboBox ID="cbTipoParticipante" runat="server" AllowCustomText="True" CausesValidation="False" DataSourceID="SqlTipoParticipante" DataTextField="Descripcion" DataValueField="TipoParticipanteID" EmptyMessage="Buscar..." Filter="Contains" Style="margin-left: 0px" Width="215px">
                                </telerik:RadComboBox>
