<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_EditarTipoPeriodo" Codebehind="EditarTipoPeriodo.aspx.vb" %>
...
<head id="Head1" runat="server">
    <title>Editar Tipo Periodo (Periodicidad)</title>
    ...
    <form id="form1" runat="server" style="background-color: #F1F5FB">
        ...
        <div>
            <table class="style1">
                ...
                <tr>
                    <td class="style8">
                        <asp:Label ID="Label9" runat="server" Text="Código Interno :" Width="117px" 
                            Font-Bold="False"></asp:Label>
                    </td>
                    <td class="style5">
                        <telerik:RadNumericTextBox ID="txtTipoPeriodoCodigo" Runat="server" 
...
<NumberFormat ZeroPattern="n" DecimalDigits="0"></NumberFormat>
                ...
                <tr>
                    <td class="style7">
                        <asp:Label ID="Label8" runat="server" Text="Equivalente Anual :" Width="116px" 
                            Font-Bold="False"></asp:Label>
                    </td>
                    <td class="style2">
                        <telerik:RadNumericTextBox ID="txtEquivalenteAnual" Runat="server">
<NumberFormat ZeroPattern="n" DecimalDigits="0"></NumberFormat>
                        </telerik:RadNumericTextBox>
                    </td>
                    <td class="style1">
