<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.CargaOrdenesEnFirme" CodeBehind="CargaOrdenesEnFirme.aspx.vb" %>
...
<body style="background-color: #F1F5FB">
    <form id="form1" runat="server" style="background-color: #F1F5FB">
            ...
            <div>
                <div id="Columa1" style="float: left; width: 70%">
                    <div>
                        ...
                        <asp:Label ID="lblLinea" runat="server" Text="Línea Inicial :"></asp:Label>
                                    <telerik:RadNumericTextBox ID="txtLineaInicio" runat="server" Value="1" Width="45px" DataType="System.Int32" Culture="en-US" DbValueFactor="1" LabelWidth="18px" MaxValue="999" MinValue="0">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>"></asp:SqlDataSource>
