<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ResultadoProrrateoOrdenes.aspx.vb" Inherits="Sgo.WebApp.ResultadoProrrateoOrdenes" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" id="html">
    ...
    <head id="Head1" runat="server">
        <title>Resultado Prorrateo de Ordenes LOIG</title>
              ...
              <telerik:ReportViewer ID="ReportViewer1" runat="server" height="600px"
                Width="100%" ViewMode="PrintPreview">
                   ...
                   <Resources CurrentPageToolTip="Página Actual" ExportButtonText="Exportar"
                       ...
                       SessionHasExpiredMessage="Por favor, actualice la página." ReportParametersSelectAValueText="<seleccionar un valor>">
                   </Resources>
