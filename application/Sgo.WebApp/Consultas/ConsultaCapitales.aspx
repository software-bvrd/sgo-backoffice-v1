            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False" ShowGroupPanel="True"
                ...
                <MasterTableView DataSourceID="SqlvConsultaCapitales" CommandItemDisplay="TopAndBottom" DataKeyNames="num_oper,fecha_oper" ShowGroupFooter="true" ShowFooter="true">
                    ...
                    <Columns>
                        ...
                        <telerik:GridNumericColumn DataField="tasa_interes" FilterControlAltText="Filter tasa_interes column" HeaderText="TASA_FACIAL" SortExpression="tasa_interes" UniqueName="tasa_interes">
                            <FooterStyle HorizontalAlign="Right" />
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridNumericColumn>
                        <telerik:GridNumericColumn DataField="valor_nom_tot" DataType="System.Decimal" FilterControlAltText="Filter valor_nom_tot column" HeaderText="VAL_FACIAL" SortExpression="valor_nom_tot" UniqueName="valor_nom_tot">
                        ...
                        <telerik:GridBoundColumn DataField="fecha_liquid" DataType="System.DateTime" FilterControlAltText="Filter fecha_liquid column" HeaderText="FEC PLAZO" SortExpression="fecha_liquid" UniqueName="fecha_liquid"
                         ...
                         <telerik:GridBoundColumn DataField="EMI_AVAL" FilterControlAltText="Filter EMI_AVAL column" HeaderText="EMI_AVAL" ReadOnly="True" SortExpression="EMI_AVAL" UniqueName="EMI_AVAL">
                        </telerik:GridBoundColumn>
