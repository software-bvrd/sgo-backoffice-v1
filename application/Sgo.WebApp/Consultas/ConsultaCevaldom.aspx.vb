...
Partial Class Consultas_ConsultaVectorPrecios
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        InjectScriptLabel.Text = ""
            ...
            If Not IsPostBack Then
                ...
                Dim FechaOperacion As Date = oper.ExecuteScalar("Select Top(1) FECHA_REGISTRO from [vConsultaVectorPreciosDetalleCevaldom] order by FECHA_REGISTRO desc")
                cStringWhere = String.Format("[FECHA_REGISTRO]='{0}'", FechaOperacion)
            ...
            If cStringWhere.IndexOf("01/01/0001") > 0 Then
                ...
                If Not IsPostBack Then
                    editor.FieldName = "Fecha Registro"
                    editor.DataType = GetType(Date)

                    Dim expr As New RadFilterEqualToFilterExpression(Of Date)("FECHA_REGISTRO")
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick, RadToolBar2.ButtonClick
        If e.Item.Value <> "" Then
            ...
            If e.Item.Value = 0 Then 'Mover
                InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../Consultas/ConsultaCevaldom.aspx','1000','600')</" + "script>"
            ...
            ElseIf e.Item.Value = 2 Then 'Guardar
                ...
                MyWindow.NavigateUrl = String.Format("NombreConsultaUsuario.aspx?ID={0}&NC=ConsultaCevaldom&U={1}&NCU={2}&F={3}", txtIdConsulta.Text, txtIdUsuario.Text, txtNombreConsultaUsuario.Text, RadFilter1.SaveSettings()) '& "&S=" & cSettingGrid
        ...
        Else
            ...
            If e.Item.Text <> "" Then
                ...
                Page.Header.Title = "Consulta Cevaldom -> " & e.Item.Text
    ...
    Protected Sub CargarInformacionFiltro(cNombreConsultaUsuario As String)
        ...
        Dim ds As DataSet = oper.ExDataSet(String.Format("SELECT idConsulta,Filtro,EstruturaGrid FROM  [vFiltrosConsultas]  where NombreConsultaUsuario='{0}' AND IdUsuario='{1}' AND NombreConsulta='ConsultaCevaldom'", cNombreConsultaUsuario, txtIdUsuario.Text))
    ...
    Protected Sub LlenarInformacionListaFiltros()
        ...
        Dim ds As DataSet = oper.ExDataSet(String.Format("SELECT NombreConsultaUsuario FROM  [vFiltrosConsultas]  where IdUsuario='{0}' AND NombreConsulta='ConsultaCevaldom'", txtIdUsuario.Text))
        Dim MyRow As DataRow
        Dim cStringFiltro As String = ""
    ...
    Protected Sub LlenarInformacionListaFiltros1()
        ...
        Dim ds As DataSet = oper.ExDataSet(String.Format("SELECT NombreConsultaUsuario FROM  [FiltrosConsultas]  where IdUsuario='{0}' AND NombreConsulta='ConsultaCevaldom' ORDER BY idConsulta ASC", txtIdUsuario.Text))
        Dim MyRow As DataRow
        Dim cStringFiltro As String = ""
    ...
    Sub DataRefresh()
        ...
        SqlvOperacionesCSV.SelectCommand = "SP_ConsultaCevaldom"
    End Sub
