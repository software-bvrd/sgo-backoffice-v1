...
<body style="background-color: #F1F5FB">
    <form id="form1" runat="server">
        ...
        <div class="FilterContainer">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False" ShowGroupPanel="True" DataSourceID="SqlvEmisores"
                ...
                <MasterTableView DataSourceID="SqlvEmisores" CommandItemDisplay="TopAndBottom" ShowGroupFooter="true" ShowFooter="true" DataKeyNames="EmisorID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="FechaCreacion" FilterControlAltText="Filter Fecha Creación column" HeaderText="FechaCreación" SortExpression="FechaCreacion" UniqueName="FechaCreacion" DataFormatString="{0:dd/MM/yyyy}"> 
                        </telerik:GridBoundColumn>
                    </Columns>
                    <EditFormSettings>
