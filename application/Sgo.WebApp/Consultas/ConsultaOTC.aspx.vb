...
Partial Class ConsultaOTC
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim FechadeOperacion As Date = oper.ExecuteScalar("Select Top(1) FechadeOperacion from [vProveedoraPreciosHechos_OTC] order by FechadeOperacion desc")
            cStringWhere = "[FechadeOperacion]='" & FechadeOperacion & "'"
            ...
            If Not IsPostBack Then
                ...
                Dim expr As New RadFilterEqualToFilterExpression(Of Date)("FechadeOperacion")

                Dim Fecha As String = oper.FormatoFechayymmdd(FechadeOperacion)
                expr.Value = Fecha
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick, RadToolBar2.ButtonClick
        If e.Item.Value <> "" Then
            ...
            If e.Item.Value = 0 Then 'Mover
                ...
                InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../Consultas/ConsultaSIV.aspx','1000','600')</" + "script>"
            ...
            ElseIf e.Item.Value = 2 Then 'Guardar
                ...
                MyWindow.NavigateUrl = "NombreConsultaUsuario.aspx?ID=" & txtIdConsulta.Text & "&NC=ConsultaSIV&U=" & txtIdUsuario.Text & "&NCU=" & txtNombreConsultaUsuario.Text & "&F=" & RadFilter1.SaveSettings()
        ...
        Else
            ...
            If e.Item.Text <> "" Then
                ...
                Page.Header.Title = "Consulta SIV -> " & e.Item.Text
    ...
    Protected Sub LlenarInformacionListaFiltros1()
        ...
        Dim ds As DataSet = oper.ExDataSet("SELECT NombreConsultaUsuario FROM  [FiltrosConsultas]  where IdUsuario='" & txtIdUsuario.Text & "' AND NombreConsulta='ConsultaSIV' ORDER BY idConsulta ASC")
        Dim MyRow As DataRow
        Dim cStringFiltro As String = ""
    ...
    Sub DataRefresh()
        ...
        SqlvOperacionesCSV.SelectCommand = "SP_ConsultaOperacionesOTC"
    End Sub
