...
Partial Class ConsultaOperaciones2
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim FechaOperacion As Date = oper.ExecuteScalar("Select Top(1) fecha_oper from [vConsultaOperacionesCSV2] order by fecha_oper desc")
    ...
    Protected Sub GenXMLforOperationCEVALDOM()
        If (txtfecha.Value <> 0) Then
            ...
            Dim Sqltext As String = "SELECT  * FROM vConsultaOperacionesCSV2 where fecha_oper = '" + FechaFiltrada1.ToString() + "'"
    ...
    Sub DataRefresh()
        ...
        SqlvOperacionesCSV.SelectCommand = "SP_ConsultadeOperaciones2"
