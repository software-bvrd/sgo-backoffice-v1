<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.ConsultaOperacionesCanceladasyNoLiquidadas" CodeBehind="ConsultaOperacionesCanceladasyNoLiquidadas.aspx.vb" %>
    ...
    <form id="form1" runat="server">
                ...
                <MasterTableView DataSourceID="SqlvOperacionesCSV" CommandItemDisplay="TopAndBottom" DataKeyNames="fecha_oper, num_oper" ShowGroupFooter="true" ShowFooter="true">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Mercado"
                            FilterControlAltText="Filter mercado column" HeaderText="Estatus"
                            SortExpression="mercado" UniqueName="mercado">
                            <FooterStyle HorizontalAlign="Right" />
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn DataField="numero_operDCV" FilterControlAltText="Filter column20 column" HeaderText="No. Operación Cevaldom" SortExpression="numero_operDCV" UniqueName="column20">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="NumeroOfertaVenta" FilterControlAltText="Filter column column" HeaderText="Numero OfertaVenta" SortExpression="NumeroOfertaVenta" UniqueName="column">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="NumeroOfertaCompra" FilterControlAltText="Filter column1 column" HeaderText="Numero Oferta Compra" SortExpression="NumeroOfertaCompra" UniqueName="column1">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="PlazoOperacionfutura" FilterControlAltText="Filter column2 column" HeaderText="Plazo Operacion futura" SortExpression="PlazoOperacionfutura" UniqueName="column2">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="IDOperacionVinculada" FilterControlAltText="Filter column3 column" HeaderText="IDOperacionVinculada" SortExpression="IDOperacionVinculada" UniqueName="column3">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="PrecioReferencia" FilterControlAltText="Filter column4 column" HeaderText="PrecioReferencia" SortExpression="PrecioReferencia" UniqueName="column4">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="MetodoNegociacion" FilterControlAltText="Filter column5 column" HeaderText="MetodoNegociacion" SortExpression="MetodoNegociacion" UniqueName="column5">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Secuencia_Operacion" FilterControlAltText="Filter column6 column" HeaderText="Secuencia_Operacion" SortExpression="Secuencia_Operacion" UniqueName="column6">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Tipo_Negociacion" FilterControlAltText="Filter column7 column" HeaderText="Tipo_Negociacion" SortExpression="Tipo_Negociacion" UniqueName="column7">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Baja" FilterControlAltText="Filter column8 column" HeaderText="Baja" SortExpression="Baja" UniqueName="column8">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="NemotecnicoSIOPEL" FilterControlAltText="Filter column9 column" HeaderText="Nemo Tecnico  SIOPEL" SortExpression="NemotecnicoSIOPEL" UniqueName="column9">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Secuencia_Operación_Vinculada" FilterControlAltText="Filter column10 column" HeaderText="Secuencia_Operación_Vinculada" SortExpression="Secuencia_Operación_Vinculada" UniqueName="column10">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Fecha_Oferta_Venta" FilterControlAltText="Filter column11 column" HeaderText="Fecha_Oferta_Venta" SortExpression="Fecha_Oferta_Venta" UniqueName="column11">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Hora_Oferta_Venta" FilterControlAltText="Filter column12 column" HeaderText="Hora_Oferta_Venta" SortExpression="Hora_Oferta_Venta" UniqueName="column12">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Fecha_Oferta_Compra" FilterControlAltText="Filter column13 column" HeaderText="Fecha_Oferta_Compra" SortExpression="Fecha_Oferta_Compra" UniqueName="column13">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Hora_Oferta_Compra" FilterControlAltText="Filter column14 column" HeaderText="Hora_Oferta_Compra" SortExpression="Hora_Oferta_Compra" UniqueName="column14">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Precio_Calculado" FilterControlAltText="Filter column15 column" HeaderText="Precio_Calculado" SortExpression="Precio_Calculado" UniqueName="column15">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Fecha_Operacion_Original" FilterControlAltText="Filter column16 column" HeaderText="Fecha_Operacion_Original" SortExpression="Fecha_Operacion_Original" UniqueName="column16">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Periodicidad1" FilterControlAltText="Filter column17 column" HeaderText="Periodicidad" SortExpression="Periodicidad1" UniqueName="column17">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Compra_o_Venta" FilterControlAltText="Filter column18 column" HeaderText="Compra_o_Venta" SortExpression="Compra_o_Venta" UniqueName="column18">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Horario_original" FilterControlAltText="Filter column19 column" HeaderText="Horario_original" SortExpression="Horario_original" UniqueName="column19">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="MotivoCancelacion" FilterControlAltText="Filter Motivo de Cancelación" HeaderText="Motivo de Cancelación" SortExpression="MotivoCancelacion" UniqueName="MotivoCancelacion">
                        </telerik:GridBoundColumn>
        ...
        <div>
            <asp:SqlDataSource ID="SqlvOperacionesCSV" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>"
                SelectCommand="SELECT TOP(1) * FROM [vConsultaOperacionesCSVCanceladasyNoLiquidadas] ORDER BY [fecha_oper] DESC" DataSourceMode="DataReader">
                <SelectParameters>
