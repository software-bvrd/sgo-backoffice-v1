...
Partial Class ConsultaOperacionesCanceladasyNoLiquidadas
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim FechaOperacion As Date = oper.ExecuteScalar("Select Top(1) fecha_oper from [vOperacionesCSVCanceladasyNoLiquidadas] order by fecha_oper desc")
    ...
    Protected Sub GenXMLforOperationCEVALDOM()
        'Response.Write("CEVALDOM XML de Operationes")
        RadGrid1.MasterTableView.PageSize = RadGrid1.Items.Count
        With RadFilter1
            .FireApplyCommand()
        End With
    ...
    Sub DataRefresh()
        ...
        SqlvOperacionesCSV.SelectCommand = "SP_ConsultadeOperacionesCanceladasyNoLiquidadas"
    End Sub
