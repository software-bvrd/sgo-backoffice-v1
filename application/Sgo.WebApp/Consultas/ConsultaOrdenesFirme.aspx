...
<body style="background-color: #F1F5FB">
    <form id="form1" runat="server">
        ...
        <div class="FilterContainer">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False" ShowGroupPanel="True" DataSourceID="SqlvConsultaOrdenesFirme"
                ...
                <MasterTableView DataSourceID="SqlvConsultaOrdenesFirme" CommandItemDisplay="TopAndBottom" ShowGroupFooter="true" ShowFooter="true">
                    ...
                    <Columns>
                        ...
                        <%-- Fecha de Liquidación 2016.07.03 --%>



                        <%-- Plazo Liquidación 2016.06.21 --%>

                        <%-- Código de Rueda 2017-06-01 --%>
                        ...
                        <telerik:GridBoundColumn DataField="Precio" DataType="System.Decimal" FilterControlAltText="Filter Precio column" HeaderText="Precio" SortExpression="Precio" UniqueName="Precio" DataFormatString="{0:###,##0.000000}">
                            <FooterStyle HorizontalAlign="Right" />
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="Rendimiento" DataType="System.Decimal" FilterControlAltText="Filter Yield column" HeaderText="Yield" SortExpression="Rendimiento" UniqueName="Rendimiento" DataFormatString="{0:###,##0.0000}">
                            <FooterStyle HorizontalAlign="Right" />
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="PosicionCompraVenta" FilterControlAltText="Filter PosicionCompraVenta column" HeaderText="Posición Compra/Venta" ReadOnly="True" SortExpression="PosicionCompraVenta" UniqueName="PosicionCompraVenta">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="Secuencia" DataType="System.Decimal" FilterControlAltText="Filter Secuencia column" HeaderText="Secuencia" SortExpression="Secuencia" UniqueName="Secuencia" DataFormatString="{0:#####0}">
                            <FooterStyle HorizontalAlign="Right" />
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="FechaLiquidacion" DataType="System.DateTime"
                            FilterControlAltText="Filter FechaLiquidacion column" HeaderText="Fecha Liquidación"
                        ...
                        <telerik:GridBoundColumn DataField="PlazoLiquidacion"
                            DataType="System.Decimal"
                            DataFormatString="{0:###,##0}"
                            FilterControlAltText="Filter PlazoLiquidacion column"
                            HeaderText="Plazo Liquidación"
                            SortExpression="PlazoLiquidacion"
                            UniqueName="PlazoLiquidacion">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn DataField="CodRueda" FilterControlAltText="Filter CodRueda column" HeaderText="Código Rueda" FooterText="Totales:" SortExpression="CodRueda" UniqueName="CodRueda">
                        </telerik:GridBoundColumn>


                        <telerik:GridBoundColumn DataField="NroSecuenciaOriginal" FilterControlAltText="Filter column column" HeaderText="Nro. Se. Original" SortExpression="NroSecuenciaOriginal" UniqueName="column">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Estado" FilterControlAltText="Filter column1 column" HeaderText="Estado" SortExpression="Estado" UniqueName="column1">
                        </telerik:GridBoundColumn>


                        <telerik:GridBoundColumn DataField="valorizacion" FilterControlAltText="Filter column2 column" HeaderText="Valorización" SortExpression="valorizacion" UniqueName="column2">
                        </telerik:GridBoundColumn>


                        <telerik:GridBoundColumn DataField="NroOperacionVinculada" FilterControlAltText="NroOperacionVinculada" HeaderText="NroOperacionVinculada" SortExpression="NroOperacionVinculada" UniqueName="NroOperacionVinculada">
                        </telerik:GridBoundColumn>
        ...
        <div>
            <asp:SqlDataSource ID="SqlvConsultaOrdenesFirme" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>" DataSourceMode="DataReader" ProviderName="<%$ ConnectionStrings:CN.ProviderName %>">
                <SelectParameters>
