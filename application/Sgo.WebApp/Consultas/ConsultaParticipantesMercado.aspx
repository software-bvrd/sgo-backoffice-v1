<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.ConsultaParticipantesMercado" CodeBehind="ConsultaParticipantesMercado.aspx.vb" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Consulta Participantes Mercado</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="FilterContainer">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False" ShowGroupPanel="True"
                CellSpacing="0" DataSourceID="SqlvParticipantesMercado" GridLines="None"
                Culture="es-DO" EnableHeaderContextMenu="True"
                ShowFooter="True" AllowPaging="True">
                <GroupingSettings CaseSensitive="False" />

                <ExportSettings ExportOnlyData="True" FileName="Participantes Mercado" OpenInNewWindow="True" IgnorePaging="True">
                    <Pdf PageTitle="Participantes Mercado" />
                </ExportSettings>
                ...
                <MasterTableView DataSourceID="SqlvParticipantesMercado" CommandItemDisplay="TopAndBottom" ShowGroupFooter="true" ShowFooter="true" DataKeyNames="PuestoBolsaID">
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="PuestoBolsaID" FilterControlAltText="Filter PuestoBolsaID column" HeaderText="PuestoBolsaID" SortExpression="PuestoBolsaID" UniqueName="PuestoBolsaID" ReadOnly="True" DataType="System.Int32">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="PuestoBolsaCodigo" FilterControlAltText="Filter PuestoBolsaCodigo column" HeaderText="PuestoBolsaCodigo" SortExpression="PuestoBolsaCodigo" UniqueName="PuestoBolsaCodigo">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="PuestoBolsaCodigoOrden" FilterControlAltText="Filter PuestoBolsaCodigoOrden column" HeaderText="PuestoBolsaCodigoOrden" SortExpression="PuestoBolsaCodigoOrden" UniqueName="PuestoBolsaCodigoOrden">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="FechaConstitucion" FilterControlAltText="Filter FechaConstitucion column" HeaderText="FechaConstitucion" SortExpression="FechaConstitucion" UniqueName="FechaConstitucion" DataType="System.DateTime">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Web" FilterControlAltText="Filter Web column" HeaderText="Web" SortExpression="Web" UniqueName="Web">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="NoRegistroBV" FilterControlAltText="Filter NoRegistroBV column" HeaderText="NoRegistroBV" SortExpression="NoRegistroBV" UniqueName="NoRegistroBV">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="NoRegistroSIV" FilterControlAltText="Filter NoRegistroSIV column" HeaderText="NoRegistroSIV" SortExpression="NoRegistroSIV" UniqueName="NoRegistroSIV">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="RepresentanteLegal" FilterControlAltText="Filter RepresentanteLegal column" HeaderText="RepresentanteLegal" SortExpression="RepresentanteLegal" UniqueName="RepresentanteLegal">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="Presidente" FilterControlAltText="Filter Presidente column" HeaderText="Presidente" SortExpression="Presidente" UniqueName="Presidente">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn DataField="Descripcion" FilterControlAltText="Filter Descripcion column" HeaderText="Tipo Participante" SortExpression="Descripcion" UniqueName="Descripcion">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn DataField="ClasificacionParticipante" FilterControlAltText="Filter ClasificacionParticipante column" HeaderText="Clasificación Participante" SortExpression="ClasificacionParticipante" UniqueName="ClasificacionParticipante">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn DataField="CodigoSiopel" FilterControlAltText="Filter CodigoSiopel column" HeaderText="Código Siopel" SortExpression="CodigoSiopel" UniqueName="CodigoSiopel">
                        </telerik:GridBoundColumn>
        ...
        <div>
            <asp:SqlDataSource ID="SqlvParticipantesMercado" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>"
                SelectCommand="SELECT * FROM [vPuestoBolsa]" DataSourceMode="DataReader">
                <SelectParameters>
