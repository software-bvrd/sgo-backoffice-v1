...
Partial Class Consultas_ConsultaSIV
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim FechaOperacion As Date = oper.ExecuteScalar("Select Top(1) FechaOperacion  from [vConsultaSIV] order by FechaOperacion desc")
            cStringWhere = "[FechaOperacion]='" & FechaOperacion & "'"
            ...
            If Not IsPostBack Then
                ...
                Dim expr As New RadFilterEqualToFilterExpression(Of Date)("FechaOperacion")
    ...
    Sub DataRefresh()
        ...
        SqlvOperacionesCSV.SelectCommand = "SP_ConsultaSIV"
    End Sub
