<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConsultaUsuariosSiopel.aspx.vb" Inherits="Sgo.WebApp.ConsultaUsuariosSiopel" %>
    ...
    <form id="form1" runat="server">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False" ShowGroupPanel="True" DataSourceID="SqlvUsuariosSiopel"
                ...
                <MasterTableView DataSourceID="SqlvUsuariosSiopel" CommandItemDisplay="TopAndBottom" ShowGroupFooter="true" ShowFooter="true" DataKeyNames="BO_Usuarios_Siopel_TID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="BO_Usuarios_Siopel_TID"
                            DataType="System.Int32"
                            FilterControlAltText="Filter InstrumentoID column"
                            HeaderText="BO_Usuarios_Siopel_TID"
                            ReadOnly="True"
                            SortExpression="BO_Usuarios_Siopel_TID"
                            UniqueName="BO_Usuarios_Siopel_TID"
                            Display="false">
                        ...
                        <telerik:GridBoundColumn DataField="TipoUsuarios_Siopel"
                            FilterControlAltText="Filter TipoUsuarios_Siopel column"
                            HeaderText="Tipo Usuario Siopel"
                            SortExpression="TipoUsuarios_Siopel"
                            UniqueName="TipoUsuarios_Siopel"
                            AndCurrentFilterFunction="Contains"
                            AutoPostBackOnFilter="True">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="BO_TipoUsuarios_Siopel_TID"
                            DataType="System.Int32"
                            FilterControlAltText="Filter TipoInstrumentoID column"
                            HeaderText="Tipo Usuario Siopel"
                            SortExpression="BO_TipoUsuarios_Siopel_TID"
                            UniqueName="BO_TipoUsuarios_Siopel_TID"
                            Visible="False">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="FechaCreacion" FilterControlAltText="Filter FechaCreacion column" HeaderText="Fecha Creación" SortExpression="FechaCreacion" UniqueName="FechaCreacion">
                        </telerik:GridBoundColumn>
        ...
        <div>
            <asp:SqlDataSource ID="SqlvUsuariosSiopel" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>"
                SelectCommand="SELECT * FROM [vUsuariosSiopel]" DataSourceMode="DataReader">
                <SelectParameters>
