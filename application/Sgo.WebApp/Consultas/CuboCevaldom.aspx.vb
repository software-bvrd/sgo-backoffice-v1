...
Partial Class Herramientas_CuboOperaciones
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Consulta: Cubo de Cevaldom", "Cubo de Cevaldom", "")
