<%@ Page Language="VB" AutoEventWireup="true" Inherits="Sgo.WebApp.CuboInstrumentos" Codebehind="CuboInstrumentos.aspx.vb" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="Herramientas" style="margin-bottom: 10px; float: left">
            <radarcube:TOLAPToolbox ID="BarraHerramienta" runat="server" ExportID="Exportar" GridID="Grid">
                <SaveLayoutButton Tooltip="Guardar diseño actual" FileName="Cubo Instrumentos"></SaveLayoutButton>
                ...
                <ExportJPEGButton Tooltip="Exportar vista a formato {0} " FileName="CuboInstrumentos"></ExportJPEGButton>

                <ExportCSVButton Tooltip="Exportar vista a formato {0} " FileName="CuboInstrumentos"></ExportCSVButton>

                <ExportXLSButton Tooltip="Exportar vista a formato {0} " FileName="CuboInstrumentos"></ExportXLSButton>

                <ExportHTMLButton Tooltip="Exportar vista a formato {0} " FileName="CuboInstrumentos"></ExportHTMLButton>

                <ExportPDFButton Tooltip="Exportar vista a formato {0} " FileName="CuboInstrumentos"></ExportPDFButton>
        ...
        <div id="BotonMover">
            <asp:Button ID="Mover" CssClass="MoverFondo" runat="server" ToolTip="Nueva ventana" OnClientClick="ventanaSecundaria('../Consultas/CuboInstrumentos.aspx',1000,600)" />
        </div>
        ...
        <div>
            <cc1:TOLAPCube ID="Cubo" runat="server" CubeGuid="" DataSourceID="SqlInstrumento" FactTableName="DefaultView">
                <Measures>
                    ...
                    <radarcube:TCubeMeasure DataTable="DefaultView" DisplayName="Inversion Minima" SourceField="InversionMinima" SourceFieldType="System.Decimal" UniqueName="b98d336c-3b3a-4811-a692-fdf90f735018" Visible="True" />
                    <radarcube:TCubeMeasure DataTable="DefaultView" DisplayName="Inversion Maxima" SourceField="InversionMaxima" SourceFieldType="System.Decimal" UniqueName="e843079e-4a8a-46a3-bb5e-91afec393c1f" Visible="True" />
                    <radarcube:TCubeMeasure AggregateFunction="stAverage" DataTable="DefaultView" DisplayName="Cupon" SourceField="Cupon" SourceFieldType="System.Decimal" UniqueName="24dc7961-377f-481c-9b82-feb2ef16b9ef" Visible="True" />
                    <radarcube:TCubeMeasure AggregateFunction="stAverage" DataTable="DefaultView" DisplayName="Spread" SourceField="Spread" SourceFieldType="System.Decimal" UniqueName="f30e1023-1d0b-44ed-a6ba-d4a8447216e3" Visible="True" />
                </Measures>
                <Dimensions>
                ...
                <CubeTablePositions>
                    <cc1:TCubeTablePosition Name="DefaultView" Position="216, 13" />
                </CubeTablePositions>
            </cc1:TOLAPCube>
        </div>
        ...
        <div>
            ...
            <asp:SqlDataSource ID="SqlInstrumento" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>" DataSourceMode="DataReader" SelectCommand="SELECT * FROM [vInstrumentosStart_TO]"></asp:SqlDataSource>
        </div>
