...
Partial Class CuponContraParte
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim FechaOperacion As Date = oper.ExecuteScalar("Select Top(1) FECHA AS Fecha  from [dbo].[V_CONTRAPARTE] order by FECHA desc")
        ...
        If txtNombreConsultaUsuario.Text <> "" Then
            Page.Header.Title = "Consulta de Cupo de Contraparte -> " & txtNombreConsultaUsuario.Text
        End If
        oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Consulta: Cupo de Contraparte", "Consulta de Cupo de Contraparte", "")
    End Sub
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick, RadToolBar2.ButtonClick
        If e.Item.Value <> "" Then
            ...
            If e.Item.Value = 0 Then 'Mover
                ...
                InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../Consultas/CupoContraParte.aspx','1000','600')</" + "script>"
            ...
            ElseIf e.Item.Value = 2 Then 'Guardar
                ...
                MyWindow.NavigateUrl = "NombreConsultaUsuario.aspx?ID=" & txtIdConsulta.Text & "&NC=CupoContraParte&U=" & txtIdUsuario.Text & "&NCU=" & txtNombreConsultaUsuario.Text & "&F=" & RadFilter1.SaveSettings()
        ...
        Else
            ...
            If e.Item.Text <> "" Then
                ...
                Page.Header.Title = "Consulta Cupo de Contraparte-> " & e.Item.Text
    ...
    Sub DataRefresh()
        ...
        SqlCupoContraparte.SelectCommandType = SqlDataSourceCommandType.StoredProcedure
        ...
        SqlCupoContraparte.SelectParameters("SqlWhere").DefaultValue = cStringWhere
        SqlCupoContraparte.SelectCommand = "SP_ConsultaCupoContraparte"
    End Sub
