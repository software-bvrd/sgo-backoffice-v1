<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.EditarPuestoBolsaCorredor" Culture="es-DO" CodeBehind="EditarPuestoBolsaCorredor.aspx.vb" %>
                ...
                <telerik:RadPageView ID="RadPageView1" runat="server" Height="427px" Width="144px">
                    <table class="style1">
                        ...
                        <tr>
                            ...
                            <td class="style16" colspan="2">
                                <telerik:RadTextBox ID="txtDireccion2" runat="server" Width="265px" TabIndex="2">
                                </telerik:RadTextBox>
                            </td>
                            <td class="style14"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="style16" colspan="2">
                                <telerik:RadMaskedTextBox ID="txtTelefonoCorredor" runat="server" Mask="(###) ###-####" TabIndex="3">
                                </telerik:RadMaskedTextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="style16" colspan="2">
                                <telerik:RadMaskedTextBox ID="txtTelefonoCasa" runat="server" Mask="(###) ###-####" TabIndex="4">
                                </telerik:RadMaskedTextBox>
                            </td>
                            <td class="style37">&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="style16" colspan="2">
                                <telerik:RadMaskedTextBox ID="txtTelefonoCelular" runat="server" Mask="(###) ###-####" TabIndex="5">
                                </telerik:RadMaskedTextBox>
                            </td>
                            <td class="style14">
                            ...
                            <td class="style37">
                                ...
                                <telerik:RadUpload ID="RadUpload1" runat="server" ControlObjectsVisibility="None" EnableTheming="True" Height="25px" TabIndex="11" Width="230px">
                        ...
                        <tr>
                            ...
                            <td class="style16" colspan="2">
                                <telerik:RadTextBox ID="txtEmailCorredor" runat="server" Width="241px" TabIndex="6">
                                </telerik:RadTextBox>
                            </td>
                            <td class="style14">&nbsp;</td>
                            <td class="style37">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td class="style16" colspan="2">
                                <telerik:RadTextBox ID="txtEmailPersonal" runat="server" Width="241px" TabIndex="7">
                                </telerik:RadTextBox>
                            </td>
                            <td class="style14">&nbsp;</td>
                            <td class="style37">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td class="style16" colspan="2">
                                <telerik:RadTextBox ID="txtNota" runat="server" Width="265px" Height="55px" TabIndex="8" TextMode="MultiLine">
                                </telerik:RadTextBox>
                            </td>
                            <td class="style14">&nbsp;</td>
                            <td class="style37">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td class="style16" colspan="2">
                                <telerik:RadTextBox ID="txtCodBVRD" runat="server" TabIndex="9" Width="200px">
                                </telerik:RadTextBox>
                            </td>
                            <td class="style14">
                        ...
                        <tr>
                            ...
                            <td class="style16" colspan="2">
                                <telerik:RadTextBox ID="txtCodBLUUID" runat="server" TabIndex="10" Width="200px">
                                </telerik:RadTextBox>
                            </td>
                            <td class="style14" rowspan="2">&nbsp;</td>
