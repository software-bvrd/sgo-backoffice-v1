...
Partial Class EditarPuestoBolsaCorredor
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            txtCodigoPuestoBolsa.Text = Request.QueryString("PuestoBolsaID") 'PuestoBolsaID
            ...
            If ViewState("EsNuevo") = False And ViewState("EstaBorrando") = False Then 'actualizar
                ...
                Select Case Me.RadTabStrip1.SelectedIndex
                    ...
                    Case 0 'Datos personales
                        ...
                        Call ActualizarDatosPersonales()
                        Call EditarDatosPersonales()
...
#Region "Datos Personales"
    ...
    Sub InsertarDatosPersonales(ByVal CodigoPuestoBolsa As String)
        ...
        Try
            ...
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Insertar Puesto Bolsa Corredor (Datos Personales)", "EditarPuestoBolsaCorredor", cSql)
    ...
    Sub ActualizarDatosPersonales()
        ...
        Try
            ...
            cSql = oper.CovertirComandoATexto(cmd)
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Actualizar Puesto Bolsa Corredor (Datos Personales)", "EditarPuestoBolsaCorredor", cSql)
...
#Region "Licencia"
    ...
    Sub InsertarLicencia(ByVal CodigoPuestoBolsaCorredorID As String)
        ...
        Try
            ...
            cSql = oper.CovertirComandoATexto(cmd)
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Insertar Puesto Bolsa Corredor (Datos Licencia)", "EditarPuestoBolsaCorredor", cSql)
    ...
    Sub ActualizarLicencia()
        ...
        Try
            ...
            cSql = oper.CovertirComandoATexto(cmd)
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Actualizar Puesto Bolsa Corredor (Datos Licencia)", "EditarPuestoBolsaCorredor", cSql)
    ...
    Sub BorrarLicencia()
        ...
        If ViewState("IDL") <> "" Then
            ...
            If oper.ExecuteNonQuery(cSql) Then
                ...
                oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Borrar Puesto Bolsa Corredor (Datos Licencia)", "EditarPuestoBolsaCorredor", cSql)
