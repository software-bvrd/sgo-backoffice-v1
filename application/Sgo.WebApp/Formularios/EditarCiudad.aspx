<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_EditarCiudad" Codebehind="EditarCiudad.aspx.vb" %>
    ...
    <form id="form1" runat="server" style="background-color: #F1F5FB">
        ...
        <div>
            <telerik:RadToolBar ID="RadToolBar1" Runat="server" Width="100%">
                <Items>
                    ...
                    Text="Guardar" ToolTip="Guardar Información" Value="0" TabIndex="1"></telerik:RadToolBarButton>
        ...
        <div>
            <table class="style1">
                ...
                <tr>
                    <td class="style1">
                        <asp:Label ID="Label8" runat="server" Text="Pais :" Width="137px" 
                            Font-Bold="False"></asp:Label>
                    </td>
                    <td class="style1">
                        <telerik:RadComboBox ID="RadComboBox1" runat="server" AllowCustomText="True" 
                            AutoPostBack="True" CausesValidation="False" DataSourceID="SqlPais" 
                            DataTextField="Nombre" DataValueField="PaisID" 
                            EmptyMessage="Buscar..." Filter="Contains" Height="200px" Width="300px" 
                    ...
                    <td class="style1">
                        ...
                        SetFocusOnError="True" Width="28px" ToolTip="Debe ingresar un nombre válido.">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="style1">
                    ...
                    <td class="style1">
                        ...
                        SetFocusOnError="True" Width="23px" ToolTip="Debe ingresar un nombre válido.">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="style1">
