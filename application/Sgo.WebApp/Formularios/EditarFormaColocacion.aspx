<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_EditarFormaColocacion" Codebehind="EditarFormaColocacion.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Editar Forma Colocación</title>
    ...
    <form id="form1" runat="server" style="background-color: #F1F5FB">
        ...
        <div>
            <table class="style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                            ...
                            SetFocusOnError="True" Width="27px" ToolTip="Debe ingresar un nombre válido.">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="style1">
                        <asp:Label ID="Label8" runat="server" Text="Mercado :" Width="137px"
                            Font-Bold="False"></asp:Label>
                    </td>
                    <td class="style1">&nbsp;
                        <telerik:RadComboBox ID="RadComboBox1" runat="server" AllowCustomText="True"
                            AutoPostBack="True" CausesValidation="False" DataSourceID="SqlMercado"
                            DataTextField="Nombre" DataValueField="MercadoID"
                    ...
                    <td class="style1">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                            ...
                            SetFocusOnError="True" Width="26px" ToolTip="Debe ingresar un nombre válido.">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="style1">
                ...
                <tr>
                    <td class="style4">
                        <asp:SqlDataSource ID="SqlMercado" runat="server"
                            ConnectionString="<%$ ConnectionStrings:CN %>"
                            SelectCommand="SELECT * FROM [Mercado] WHERE ([Activo] = @Activo)">
                            <SelectParameters>
