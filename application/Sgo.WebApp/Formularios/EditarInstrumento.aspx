        ...
        <div>
            <table class="style1">
                ...
                <tr>
                    ...
                    <td class="style2">
                        <telerik:RadTextBox ID="txtNombre" runat="server" Height="24px" LabelWidth="64px"
                            Width="327px" Style="margin-left: 4px">
                        </telerik:RadTextBox>
                    </td>
                    <td class="style3">
                ...
                <tr>
                    ...
                    <td class="style2">
                        <telerik:RadTextBox ID="txtCodSistema" runat="server" Height="24px" LabelWidth="64px"
                            Width="113px" Style="margin-left: 4px">
                        </telerik:RadTextBox>
                    </td>
                    <td class="style3">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="style2">&nbsp;<telerik:RadComboBox ID="RadComboBox1" runat="server" AllowCustomText="True"
