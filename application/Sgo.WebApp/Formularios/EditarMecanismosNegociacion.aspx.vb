Public Class EditarMecanismosNegociacion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            Else
                ViewState("Code") = Request.QueryString("MecanismosNegociacionID")
            End If
    ...
    Sub Nuevo()
        If ViewState("EsNuevo") = True Then
            ...
            oper.ExecuteNonQuery("INSERT INTO MecanismosNegociacion (Descripcion, CodigoMercado ,Estatus) VALUES ('" & txtDescripcion.Text & "','" & txtCodigoMercado.Text & "','" & Check & "')")
        End If
    End Sub

    Sub Editar()
        Dim ds As DataSet = oper.ExDataSet("SELECT * FROM  [MecanismosNegociacion]  where MecanismosNegociacionID='" & CInt(ViewState("Code")) & "'")
    ...
    Sub Actualizar()
        Dim Check As String
        Check = CheckBox1.Checked
        oper.ExecuteNonQuery("Update [MecanismosNegociacion] set  Descripcion='" & txtDescripcion.Text & "',CodigoMercado='" & txtCodigoMercado.Text & "', Estatus='" & Check & "'  where MecanismosNegociacionID='" & CInt(ViewState("Code")) & "'")
    ...
    Sub Borrar()
        ...
        VerificarPuestoBolsaID = oper.ExecuteScalar("Select count (*) from dbo.PuestoBolsaMecanismosNegociacion  where MecanismosNegociacionID='" & ViewState("Code") & "'")
        ...
        Else
            If oper.ExecuteNonQuery("delete from dbo.MecanismosNegociacion where MecanismosNegociacionID='" & ViewState("Code") & "'") Then
