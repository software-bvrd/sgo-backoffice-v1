<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_EditarMoneda" Codebehind="EditarMoneda.aspx.vb" %>
    ...
    <form id="form1" runat="server" style="background-color: #F1F5FB">
        ...
        <div>
            <table class="style1">
                <tr>
                    <td class="style4">
                        <asp:Label ID="Label1" runat="server" Text="Nombre :" Width="84px"
                ...
                <tr>
                    <td class="style4">
                        <asp:Label ID="Label2" runat="server" Text="Símbolo :" Width="94px"></asp:Label>
                    </td>
                    <td class="style3">
                        <telerik:RadTextBox ID="txtSimbolo" runat="server" Height="21px"
                            Style="margin-left: 5px" Width="84px">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                            ControlToValidate="txtSimbolo" ErrorMessage="Name" Font-Size="Small" ForeColor="Red"
                            SetFocusOnError="True" Width="22px" ToolTip="Debe ingresar un nombre válido.">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="style1">
                        <asp:Label ID="Label3" runat="server" Text="Local :" Width="79px"></asp:Label>
                    </td>
                    <td class="style1">
