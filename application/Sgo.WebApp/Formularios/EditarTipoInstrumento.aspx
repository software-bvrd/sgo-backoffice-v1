<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_EditarTipoInstrumento" CodeBehind="EditarTipoInstrumento.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Editar Tipo Instrumento</title>
    ...
    <form id="form1" runat="server" style="background-color: #F1F5FB">
        ...
        <div>
            <table class="style1">
                ...
                <tr>
                    <td class="style2">
                        <asp:Label ID="Label8" runat="server" Text="Tipo Mercado :" Width="112px" 
