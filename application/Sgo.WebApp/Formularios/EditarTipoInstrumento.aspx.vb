...
Partial Class Formularios_EditarTipoInstrumento
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            Else
                ViewState("Code") = Request.QueryString("TipoInstrumentoID")
            End If
    ...
    Sub Nuevo()
        If ViewState("EsNuevo") = True Then
            ...
            oper.ExecuteNonQuery("INSERT INTO TipoInstrumento (Nombre,TipoMercadoID, Activo) VALUES ('" & txtNombre.Text & "','" & Me.RadComboBox1.SelectedValue & "','" & Check & "')")
        End If
    End Sub

    Sub Editar()
        Dim ds As DataSet = oper.ExDataSet("SELECT * FROM  [TipoInstrumento]  where TipoInstrumentoID='" & CInt(ViewState("Code")) & "'")
    ...
    Sub Actualizar()
        Dim Check As String
        Check = CheckBox1.Checked
        oper.ExecuteNonQuery("Update [TipoInstrumento] set  Nombre='" & txtNombre.Text & "', TipoMercadoID = '" & Me.RadComboBox1.SelectedValue & "', Activo='" & Check & "'  where TipoInstrumentoID='" & CInt(ViewState("Code")) & "'")
        ViewState("EsNuevo") = False
    End Sub

    Sub Borrar()
        If oper.ExecuteNonQuery("delete from dbo.TipoInstrumento where TipoInstrumentoID='" & ViewState("Code") & "'") Then
