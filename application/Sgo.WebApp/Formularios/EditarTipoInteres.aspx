<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_EditarTipoInteres" Codebehind="EditarTipoInteres.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Editar Tipo Interés</title>
            ...
            <table class="style1">
                <tr>
                    ...
                    <td class="style4">
                        ...
                        Width="292px" style="margin-left: 4px"></telerik:RadTextBox>
                    </td>
                    <td class="style2">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                        ControlToValidate="txtNombre" ErrorMessage="Name" Font-Size="Small" ForeColor="Red"
                        SetFocusOnError="True" Width="17px" ToolTip="Debe ingresar un nombre válido." 
                ...
                <tr>
                    ...
                    <td class="style4">
                        <telerik:RadTextBox ID="txtTipoInteresCodigo" Runat="server" Height="24px" LabelWidth="64px"
                        Width="93px" style="margin-left: 4px"></telerik:RadTextBox>
                    </td>
                    <td class="style2">
                        &nbsp;</td>
                </tr>
