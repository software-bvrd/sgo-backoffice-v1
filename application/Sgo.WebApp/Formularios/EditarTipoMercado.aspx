<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_EditarTipoMercado" Codebehind="EditarTipoMercado.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Editar Tipo Mercado</title>
                ...
                <tr>
                    <td class="style4">
                        <asp:SqlDataSource ID="SqlTipoMercado" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>"
                            SelectCommand="SELECT * FROM [TipoMercado]"></asp:SqlDataSource>
                    </td>
                    <td class="style3">
