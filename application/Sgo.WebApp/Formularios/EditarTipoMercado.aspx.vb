...
Partial Class Formularios_EditarTipoMercado
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            Else
                ViewState("Code") = Request.QueryString("TipoMercadoID")
            End If
        ...
        End If
        'Borrar tipo mercado utilizando la confirmacion del usuario
    ...
    Sub Nuevo()
        If ViewState("EsNuevo") = True Then
            oper.ExecuteNonQuery("INSERT INTO TipoMercado (Nombre) VALUES ('" &
                                 Me.txtNombre.Text & "')")
        End If
    End Sub

    Sub Editar()
        Dim ds As DataSet = oper.ExDataSet("SELECT Nombre FROM  [TipoMercado]  where TipoMercadoID='" & CInt(ViewState("Code")) & "'")
    ...
    Sub Actualizar()
        oper.ExecuteNonQuery("Update [TipoMercado] set  Nombre ='" & txtNombre.Text & "' where TipoMercadoID='" & CInt(ViewState("Code")) & "'")
        ViewState("EsNuevo") = False
    End Sub
    Sub Borrar()
        If oper.ExecuteNonQuery("delete from dbo.TipoMercado where TipoMercadoID='" & ViewState("Code") & "'") Then
