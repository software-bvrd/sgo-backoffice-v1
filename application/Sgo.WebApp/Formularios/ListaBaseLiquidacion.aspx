    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowAutomaticDeletes="True"
                ...
                <ExportSettings ExportOnlyData="True" FileName="Lista de Base Liquidación"
                    OpenInNewWindow="True" IgnorePaging="True">
                    <Pdf PageTitle="Lista de Base Liquidación" Title="Lista de Base Liquidación" />
                     <%--<Excel Format="Xlsx" />--%>
                    <Word Format="Docx" />
                </ExportSettings>
                ...
                <MasterTableView Caption="Lista Base de Liquidación" CommandItemDisplay="None"
