...
Imports System.Data
Partial Class Formularios_ListaCiudad
    ...
    Protected Sub RadToolBar1_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 0 Then 'Nuevo
            ...
            MyWindow.NavigateUrl = "EditarCiudad.aspx?EsNuevo=" & True
        ...
        ElseIf e.Item.Value = 1 Then 'Editar
            ...
            For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
                ViewState("Code") = dataItem("CiudadID").Text
                ViewState("Seleccionado") = 1
            Next
            If ViewState("Seleccionado") = 1 Then
                Dim MyWindow As New Telerik.Web.UI.RadWindow
                MyWindow.NavigateUrl = "EditarCiudad.aspx?CiudadID=" & ViewState("Code") & "&EsNuevo=" & False
                MyWindow.VisibleOnPageLoad = True
        ...
        ElseIf e.Item.Value = 2 Then 'Cancelar
            InjectScriptLabelImprimir.Text = "<script>CerrarVentana()</" + "script>"

        ElseIf e.Item.Value = 3 Then 'Borrrar
            For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
                ViewState("Code") = dataItem("CiudadID").Text
            Next
            If ViewState("Code") Then
                InjectScriptLabel.Text = "<script>MensajePopup('Seleccione una registro para Borrar.')</" + "script>"
            Else
                If oper.ExecuteNonQuery("delete from dbo.vCiudad  where CiudadID='" & ViewState("Code") & "'") Then
        ...
        ElseIf e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../Formularios/ListaCiudad.aspx','1000','600')</" + "script>"
    ...
    Protected Sub RadAjaxManager1_AjaxRequest(ByVal sender As Object, ByVal e As Telerik.Web.UI.AjaxRequestEventArgs) Handles RadAjaxManager1.AjaxRequest
        For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
            Session("Code") = dataItem("CiudadID").Text
            Session("Ajax") = True
        Next
    End Sub
End Class
