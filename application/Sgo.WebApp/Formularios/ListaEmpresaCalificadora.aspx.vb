...
Partial Class Formularios_ListaEmpresaCalificadora
    ...
    Protected Sub RadToolBar1_ButtonClick(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 0 Then 'Nuevo
            ...
            MyWindow.NavigateUrl = "EditarEmpresaCalificadora.aspx?EsNuevo=" & True
        ...
        ElseIf e.Item.Value = 1 Then 'Editar
            ...
            For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
                ViewState("Code") = dataItem("EmpresaCalificadoraID").Text
                ViewState("Seleccionado") = 1
            Next

            If ViewState("Seleccionado") = 1 Then
                Dim MyWindow As New Telerik.Web.UI.RadWindow
                MyWindow.NavigateUrl = "EditarEmpresaCalificadora.aspx?EmpresaCalificadoraID=" & ViewState("Code") & "&EsNuevo=" & False
                MyWindow.VisibleOnPageLoad = True
        ...
        ElseIf e.Item.Value = 3 Then 'Borrar
            For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
                ViewState("Code") = dataItem("EmpresaCalificadoraID").Text
            Next
            oper.ExecuteNonQuery("delete from dbo.EmpresaCalificadora  where EmpresaCalificadoraID='" & ViewState("Code") & "'")
            Me.RadGrid1.Rebind()

        ElseIf e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../Formularios/ListaEmpresaCalificadora.aspx','1000','600')</" + "script>"
    ...
    Protected Sub RadAjaxManager1_AjaxRequest(ByVal sender As Object, ByVal e As Telerik.Web.UI.AjaxRequestEventArgs) Handles RadAjaxManager1.AjaxRequest
        For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
            Session("Code") = dataItem("EmpresaCalificadoraID").Text
            Session("Ajax") = True
        Next
    End Sub
