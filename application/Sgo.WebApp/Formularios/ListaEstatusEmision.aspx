<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_ListaEstatusEmision" CodeBehind="ListaEstatusEmision.aspx.vb" %>
    ...
    <form id="form1" runat="server">
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                function CargarVentanaEditar() {
                    VentanaEditarFlotante("EditarEstatusEmision.aspx", 550, 300, "RadAjaxManager1")
                }
        ...
        <div>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowAutomaticDeletes="True"
                ...
                CellSpacing="0" Culture="es-DO" DataSourceID="SqlListaEmisionEstatus" GridLines="None"
                AllowFilteringByColumn="True" PageSize="20" AllowSorting="True" EnableHeaderContextMenu="True">
                <GroupingSettings CaseSensitive="False" />

                <ExportSettings ExportOnlyData="True" FileName="Lista Tipo Interes"
                    OpenInNewWindow="True" IgnorePaging="True">
                    <Pdf PageTitle="Lista Tipo Interes" Title="Lista Tipo Interes" />
                    <%--<Excel Format="Xlsx" />--%>
                    <Word Format="Docx" />
                </ExportSettings>
                ...
                <MasterTableView Caption="Lista Estatus Emisiones" CommandItemDisplay="None"
                    DataKeyNames="EmisionEstatusID" DataSourceID="SqlListaEmisionEstatus" NoMasterRecordsText="No hay información para mostrar."
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="EmisionEstatusID" DataType="System.Int32"
                            FilterControlAltText="Filter EmisionEstatusID column"
                            HeaderText="EmisionEstatusID" ReadOnly="True"
                            SortExpression="EmisionEstatusID" UniqueName="EmisionEstatusID"
                            Display="false">
                        ...
                        <telerik:GridBoundColumn DataField="CodigoEstatus"
                            FilterControlAltText="Filter CodigoEstatus column"
                            HeaderText="Código Interno" SortExpression="CodigoEstatus"
                            UniqueName="CodigoEstatus" AndCurrentFilterFunction="Contains" AutoPostBackOnFilter="True">
                        </telerik:GridBoundColumn>
        ...
        <div>
            <asp:SqlDataSource ID="SqlListaEmisionEstatus" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>"
                SelectCommand="SELECT * FROM [EmisionEstatus]" DataSourceMode="DataReader"></asp:SqlDataSource>
