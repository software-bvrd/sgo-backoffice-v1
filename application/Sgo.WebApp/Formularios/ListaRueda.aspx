<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_ListaRueda" CodeBehind="ListaRueda.aspx.vb" %>
    ...
    <form id="form1" runat="server">
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                function CargarVentanaEditar() {
                    VentanaEditarFlotante("EditarRueda.aspx", 490, 230, "RadAjaxManager1")
                }
        ...
        <div>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowAutomaticDeletes="True"
                ...
                CellSpacing="0" Culture="es-DO" DataSourceID="SqlListaRueda" GridLines="None"
                AllowFilteringByColumn="True" PageSize="20" AllowSorting="True" EnableHeaderContextMenu="True">
                <GroupingSettings CaseSensitive="False" />

                <ExportSettings ExportOnlyData="True" FileName="Lista de Ruedas"
                    OpenInNewWindow="True" IgnorePaging="True">
                    <Pdf PageTitle="Lista Rueda" Title="Lista de Ruedas" />
                     <%--<Excel Format="Xlsx" />--%>
                    <Word Format="Docx" />
                </ExportSettings>
                ...
                <MasterTableView Caption="Lista de Ruedas" CommandItemDisplay="None"
                    DataKeyNames="RuedaID" DataSourceID="SqlListaRueda" NoMasterRecordsText="No hay información para mostrar."
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="RuedaID" DataType="System.Int32"
                            FilterControlAltText="Filter RuedaID column"
                            HeaderText="RuedaID" ReadOnly="True"
                            SortExpression="RuedaID" UniqueName="RuedaID"
                            Display="false">
                        ...
                        <telerik:GridBoundColumn DataField="CodRueda"
                            FilterControlAltText="Filter CodRueda column"
                            HeaderText="Código Interno" SortExpression="CodRueda"
                            UniqueName="CodRueda" AndCurrentFilterFunction="Contains" AutoPostBackOnFilter="True">
                        </telerik:GridBoundColumn>
        ...
        <div>
            <asp:SqlDataSource ID="SqlListaRueda" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>"
                SelectCommand="SELECT * FROM [Rueda]" DataSourceMode="DataReader"></asp:SqlDataSource>
