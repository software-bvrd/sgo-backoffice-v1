<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_ListaTipoInstrumento" CodeBehind="ListaTipoInstrumento.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Tipo Instrumento</title>
    ...
    <form id="form1" runat="server">
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                function CargarVentanaEditar(sender, args) {
                    VentanaEditarFlotante("EditarTipoInstrumento.aspx", 470, 230, "RadAjaxManager1")
                }
        ...
        <div>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowAutomaticDeletes="True"
                ...
                CellSpacing="0" Culture="es-DO" DataSourceID="SqlListaTipoInstrumento" GridLines="None"
                AllowFilteringByColumn="True" PageSize="20" AllowSorting="True" EnableHeaderContextMenu="True">
                <GroupingSettings CaseSensitive="False" />

                <ExportSettings ExportOnlyData="True" FileName="Lista Tipo Instrumento"
                    OpenInNewWindow="True" IgnorePaging="True">
                    <Pdf PageTitle="Lista Tipo Instrumento" Title="Lista Tipo Instrumento" />
                     <%--<Excel Format="Xlsx" />--%>
                    <Word Format="Docx" />
                </ExportSettings>
                ...
                <MasterTableView Caption="Lista Tipo Instrumento" CommandItemDisplay="None"
                    DataKeyNames="TipoInstrumentoID" DataSourceID="SqlListaTipoInstrumento" NoMasterRecordsText="No hay información para mostrar."
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="TipoInstrumentoID" DataType="System.Int32"
                            ...
                            HeaderText="TipoInstrumentoID" ReadOnly="True"
                            SortExpression="TipoInstrumentoID" UniqueName="TipoInstrumentoID"
                            Display="false">
        ...
        <div>
            <asp:SqlDataSource ID="SqlListaTipoInstrumento" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>"
                SelectCommand="SELECT TipoInstrumentoID, Nombre, Activo FROM TipoInstrumento ORDER BY Nombre"></asp:SqlDataSource>
