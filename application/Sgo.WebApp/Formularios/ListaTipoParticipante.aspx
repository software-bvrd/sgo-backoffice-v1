<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListaTipoParticipante.aspx.vb" Inherits="Sgo.WebApp.ListaTipoParticipante" %>
    ...
    <form id="form1" runat="server">
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                function CargarVentanaEditarClaPar(sender, args) {
                    ...
                    VentanaEditarFlotante("EditarTipoParticipante.aspx", 440, 200, "RadAjaxManager1")
                }
        ...
        <div>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowAutomaticDeletes="True"
                ...
                CellSpacing="0" Culture="es-DO" DataSourceID="SqlTipoParticipante" GridLines="None"
                ...
                <ExportSettings ExportOnlyData="True" FileName="Lista de Sector"
                    ...
                    <Pdf PageTitle="Lista de Tipo Participantes" Title="Lista de Tipo Participantes" />
                    <%--<Excel Format="Xlsx" />--%>
                    <Word Format="Docx" />
                </ExportSettings>
                ...
                <MasterTableView Caption="Lista de Tipo Participante" CommandItemDisplay="None"
                    DataKeyNames="TipoParticipanteID" DataSourceID="SqlTipoParticipante" NoMasterRecordsText="No hay información para mostrar."
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="TipoParticipanteID" DataType="System.Int32"
                            FilterControlAltText="Filter TipoParticipanteID column" HeaderText="TipoParticipanteID"
                            ReadOnly="True" SortExpression="TipoParticipanteID" UniqueName="TipoParticipanteID"
                            Display="false">
        ...
        <div>
            <asp:SqlDataSource ID="SqlTipoParticipante" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>"
                SelectCommand="SELECT * FROM [TipoParticipante]"></asp:SqlDataSource>
