<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.Formularios_ListaTipoPeriodo" CodeBehind="ListaTipoPeriodo.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Tipo Periodo (Periodicidad)</title>
    ...
    <form id="form1" runat="server">
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                function CargarVentanaEditar(sender, args) {
                    VentanaEditarFlotante("EditarTipoPeriodo.aspx", 500, 260, "RadAjaxManager1")
                }
        ...
        <div>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowAutomaticDeletes="True"
                ...
                CellSpacing="0" Culture="es-DO" DataSourceID="SqlListaTipoPeriodo" GridLines="None"
                AllowFilteringByColumn="True" PageSize="20" AllowSorting="True" EnableHeaderContextMenu="True">
                <GroupingSettings CaseSensitive="False" />

                <ExportSettings ExportOnlyData="True" FileName="Lista Tipo de Periodo (Periodicidad)"
                    OpenInNewWindow="True" IgnorePaging="True">
                    <Pdf PageTitle="Lista Tipo de Periodo (Periodicidad)" Title="Lista Tipo de Periodo (Periodicidad)" />
                     <%--<Excel Format="Xlsx" />--%>
                    <Word Format="Docx" />
                </ExportSettings>
                ...
                <MasterTableView Caption="Lista Tipo de Periodo (Periodicidad)" CommandItemDisplay="None"
                    DataKeyNames="TipoPeriodoID" DataSourceID="SqlListaTipoPeriodo" NoMasterRecordsText="No hay información para mostrar."
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="TipoPeriodoID" DataType="System.Int32"
                            FilterControlAltText="Filter TipoPeriodoID column" HeaderText="TipoPeriodoID"
                            ReadOnly="True" SortExpression="TipoPeriodoID" UniqueName="TipoPeriodoID"
                            Display="false">
                        ...
                        <telerik:GridBoundColumn DataField="TipoPeriodoCodigo" DataType="System.Int32"
                            FilterControlAltText="Filter TipoPeriodoCodigo column"
                            HeaderText="Código Interno" SortExpression="TipoPeriodoCodigo"
                            UniqueName="TipoPeriodoCodigo" AndCurrentFilterFunction="Contains" AutoPostBackOnFilter="True">
                        </telerik:GridBoundColumn>
                    </Columns>
                    <EditFormSettings>
        ...
        <div>
            <asp:SqlDataSource ID="SqlListaTipoPeriodo" runat="server" ConnectionString="<%$ ConnectionStrings:CN %>"
                SelectCommand="SELECT * FROM [TipoPeriodo]" DataSourceMode="DataReader"></asp:SqlDataSource>
