...
Public Class ConsultaUsuariosUsuriosSiopel
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick, RadToolBar2.ButtonClick
        If e.Item.Value <> "" Then
            ...
            If e.Item.Value = 0 Then 'Mover
                ...
                InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../herramientas/ConsultaUsuariosSiopel.aspx','1000','600')</" + "script>"
            ...
            ElseIf e.Item.Value = 2 Then 'Guardar
                ...
                MyWindow.NavigateUrl = "../consultas/NombreConsultaUsuario.aspx?ID=" & txtIdConsulta.Text & "&NC=ConsultaUsuariosSiopel&U=" & txtIdUsuario.Text & "&NCU=" & txtNombreConsultaUsuario.Text & "&F=" & RadFilter1.SaveSettings()
        ...
        Else
            ...
            If e.Item.Text <> "" Then
                ...
                Page.Header.Title = "Consulta de Usuarios Siopel -> " & e.Item.Text
    ...
    Sub DataRefresh()
        ...
        SqlvUsuariosSiopel.SelectCommand = "SP_ConsultaUsuariosSiopel"
    End Sub
