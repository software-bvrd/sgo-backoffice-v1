  ...
  <%--          <telerik:RadToolBar ID="RadToolBar2" runat="server" Width="100%">
        ...
        <div>
           <asp:Label ID="lblMensaje" runat="server" ForeColor="Red" Font-Size="Medium" Font-Bold="true" style="margin-left: auto;margin-right: auto;width: 50%;text-align:center;"></asp:Label>
            <telerik:RadGrid ID="dgVistaPrevia" runat="server" AllowSorting="True" AutoGenerateColumns="False" ShowGroupPanel="True"
                Culture="es-DO" EnableHeaderContextMenu="True" AllowPaging="True"
                ...
                <MasterTableView CommandItemDisplay="Bottom">
                    <Columns>
                        <telerik:GridBoundColumn DataField="NumeroOperacion" FilterControlAltText="Filter Numero Operacion column" HeaderText="Numero de Operacion" ReadOnly="True" SortExpression="NumeroOperacion" UniqueName="NumeroOperacion">
                        ...
                        <telerik:GridBoundColumn DataField="Descripcion" FilterControlAltText="Filter Respuesta Cevaldom column" HeaderText="Respuesta Cevaldom" ReadOnly="True" SortExpression="Descripcion" UniqueName="Descripcion">
                ...
                <div style="display:block;width:50px;margin-left: auto;margin-right: auto;width: 50%;">
            <telerik:RadProgressManager ID="RadProgressManager1" runat="server" />
            <telerik:RadProgressArea ID="RadProgressArea1" runat="server" HeaderText="Cargando Operaciones"  Height="210px" Width="700px">
                <Localization  Uploaded="Operaciones para enviar" Cancel="Cancelar" CurrentFileName=""
                    ElapsedTime="Tiempo Transcurrido: " EstimatedTime="" TotalFiles="Total Archivos: "
                    TransferSpeed="" UploadedFiles="Operaciones Cargadas:"></Localization>
            ...
            <tr>
                <td colspan="2">
                    <telerik:RadListBox ID="lstErrores" runat="server" Visible="true" Width="900px">
                    </telerik:RadListBox>
                </td>
            </tr> 
        </div>
