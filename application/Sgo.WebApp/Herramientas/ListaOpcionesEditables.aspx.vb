...
Partial Class ListaOpcionesEditables
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 0 Then ' Nuevo
            ...
            MyWindow.NavigateUrl = "EditOpcionesEditables.aspx?cmd=new"
        ...
        ElseIf e.Item.Value = 7 Then ' Mover
            InjectScriptLabel.Text = "<script>ventanaSecundaria('../Herramientas/ListaOpcionesEditables.aspx','1000','600')</" + "script>"
