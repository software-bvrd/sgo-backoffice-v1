<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListaOperacionesCancelarBO.aspx.vb" Inherits="Sgo.WebApp.ListaOperacionesCancelarBO" %>
...
<head id="Head1" runat="server">
    ...
    <title>Cancelar Operaciones BO</title>
    <style type="text/css">
        .filterDiv {
...
<body style="background-color: #F1F5FB">
    <form id="form1" runat="server">
        ...
        <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%">
            <Items>
                <telerik:RadToolBarButton runat="server" ImageUrl="~/Images/cancelaroperaciones.png"
                    Text="Cancelar Operación" ToolTip="Cancelar la Operación seleccionada" Value="2">
        ...
        <div class="FilterContainer">
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlvOperacionesCSV"
                ...
                <MasterTableView DataSourceID="SqlvOperacionesCSV" CommandItemDisplay="TopAndBottom" DataKeyNames="fecha_oper,num_oper" ShowGroupFooter="true" ShowFooter="true">
                    ...
                    <Columns>
                        ...
                        <%-- IdOperacion 2016.01.26 --%>

                        <telerik:GridBoundColumn DataField="IdOperacion"
                            FilterControlAltText="Filter IdOperacion column" HeaderText="ID. Operación"
                            ReadOnly="True" SortExpression="IdOperacion" UniqueName="IdOperacion" Display="false">
                            <FooterStyle HorizontalAlign="Right" />
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>
