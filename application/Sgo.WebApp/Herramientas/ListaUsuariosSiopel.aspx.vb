...
Public Class ListaUsuariosSiopel
    ...
    Private Sub ListaUsuariosSiopel_Init(sender As Object, e As EventArgs) Handles Me.Init
    ...
    Private Sub RadAjaxManager1_AjaxRequest(sender As Object, e As AjaxRequestEventArgs) Handles RadAjaxManager1.AjaxRequest
        For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
            Session("Code") = dataItem("BO_Usuarios_Siopel_TID").Text
            Session("Ajax") = True
        Next
    End Sub
    ...
    Private Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 0 Then ' Nuevo
            ...
            MyWindow.NavigateUrl = "EditarUsuariosSiopel.aspx?EsNuevo=" & True
        ...
        ElseIf e.Item.Value = 1 Then ' Editar
            ...
            For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
                ViewState("Code") = dataItem("BO_Usuarios_Siopel_TID").Text
                ViewState("Seleccionado") = 1
            Next

            If ViewState("Seleccionado") = 1 Then
                Dim MyWindow As New Telerik.Web.UI.RadWindow
                MyWindow.NavigateUrl = "EditarUsuariosSiopel.aspx?BO_Usuarios_Siopel_TID=" & ViewState("Code") & "&EsNuevo=" & False
                MyWindow.VisibleOnPageLoad = True
        ...
        ElseIf e.Item.Value = 3 Then 'Borrar
            For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
                ViewState("Code") = dataItem("BO_Usuarios_Siopel_TID").Text
            Next
            oper.ExecuteNonQuery("delete from dbo.BO_Usuarios_Siopel_T  where BO_Usuarios_Siopel_TID='" & ViewState("Code") & "'")
            Me.RadGrid1.Rebind()

        ElseIf e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../Formularios/ListaUsuariosSiopel.aspx','1000','600')</" + "script>"
