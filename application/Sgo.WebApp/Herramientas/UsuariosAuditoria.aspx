<%@ Page Title="" Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.UsuariosAuditoria" Codebehind="UsuariosAuditoria.aspx.vb" %>
...
<%--                <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%">
        ...
        LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            culture="es" AutoGenerateColumns="False">
                ...
                <ExportSettings ExportOnlyData="True" FileName="Usuarios Auditoria" 
                    OpenInNewWindow="True">
                    <Pdf PageTitle="Usuarios Auditoria" Title="Usuarios Auditoria" />
                </ExportSettings>
                ...
                <MasterTableView datakeynames="IdUsuario" datasourceid="SqlDataSource1"  CommandItemSettings-ShowAddNewRecordButton="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="PerfilNombre" FilterControlAltText="Filter Perfil column" HeaderText="Perfil" SortExpression="PerfilNombre" UniqueName="PerfilNombre">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="Estado" FilterControlAltText="Filter Estado column" HeaderText="Estado" SortExpression="Estado" UniqueName="Estado">
                          ...
                          <telerik:GridBoundColumn DataField="FechaCreacion" FilterControlAltText="Filter Fecha Creación column" HeaderText="FechaCreacion" SortExpression="FechaCreacion" UniqueName="FechaCreacion">
                        </telerik:GridBoundColumn>
                           <telerik:GridBoundColumn DataField="FechaInactivo" FilterControlAltText="Filter Fecha Inactivo column" HeaderText="FechaInactivo" SortExpression="FechaInactivo" UniqueName="FechaInactivo">
                        </telerik:GridBoundColumn>
                          <telerik:GridBoundColumn DataField="FechaDigitacion" FilterControlAltText="Filter Fecha Digitación column" HeaderText="FechaDigitacion" SortExpression="FechaDigitacion" UniqueName="FechaDigitacion">
                        </telerik:GridBoundColumn>
                         <telerik:GridBoundColumn DataField="Accion" FilterControlAltText="Filter Accion column" HeaderText="Accion" SortExpression="Accion" UniqueName="Accion">
                        </telerik:GridBoundColumn> 
                         <telerik:GridBoundColumn DataField="NombreUsuarioCreacion" FilterControlAltText="Filter Nombre Usuario Creación column" HeaderText="Usuario Creación" SortExpression="NombreUsuarioCreacion" UniqueName="NombreUsuarioCreacion">
                        </telerik:GridBoundColumn> 
                         <telerik:GridBoundColumn DataField="NombreUsuarioModifica" FilterControlAltText="Filter Nombre Usuario Modificación column" HeaderText="Usuario Modificación" SortExpression="NombreUsuarioModifica" UniqueName="NombreUsuarioModifica">
                        </telerik:GridBoundColumn>
                    </Columns>
            ...
            SelectCommand="SELECT * FROM [vTBL_Usuariosaudit]"></asp:SqlDataSource>
