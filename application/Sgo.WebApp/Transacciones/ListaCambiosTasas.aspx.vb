...
Partial Class Transacciones_ListaCambiosTasas
    Inherits Page
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As Telerik.Web.UI.RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        ...
        If e.Item.Value = 0 Then
            ...
            MyWindow.NavigateUrl = "EditarCambiosTasas.aspx?EsNuevo=" & True
        ...
        ElseIf e.Item.Value = 1 Then
            ...
            For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
                ViewState("Code") = dataItem("MonedasHistoricoTasasID").Text
                ViewState("Seleccionado") = 1
            Next

            If ViewState("Seleccionado") = 1 Then
                Dim MyWindow As New Telerik.Web.UI.RadWindow
                MyWindow.NavigateUrl = "EditarCambiosTasas.aspx?MonedasHistoricoTasasID=" & ViewState("Code") & "&EsNuevo=" & False
                MyWindow.VisibleOnPageLoad = True
        ...
        ElseIf e.Item.Value = 7 Then
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../transacciones/ListaCambiosTasas.aspx','1000','600')</" + "script>"
    ...
    Protected Sub RadAjaxManager1_AjaxRequest(ByVal sender As Object, ByVal e As Telerik.Web.UI.AjaxRequestEventArgs) Handles RadAjaxManager1.AjaxRequest
        For Each dataItem As Telerik.Web.UI.GridDataItem In RadGrid1.SelectedItems
            Session("Code") = dataItem("MonedasHistoricoTasasID").Text
            Session("Ajax") = True
        Next
    End Sub
