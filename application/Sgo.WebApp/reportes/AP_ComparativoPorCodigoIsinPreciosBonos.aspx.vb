...
Partial Class AP_ComparativoPorCodigoIsinPreciosBonos
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookDiario.Reports.Add(New MyReportLib.AP_ComparativoPorCodigoIsinPreciosBonos)


            ReportBookDiario.DocumentName = "ComparativoVolumenesBonosCodigoISIN" & Format(Now(), "dd-MM-yy")
            InstaciaReportSource.ReportDocument = ReportBookDiario
            ReportViewer1.ReportSource = InstaciaReportSource
            ReportViewer1.RefreshReport()
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Comparativo Precios Volúmenes de Bonos Por Código ISIN", "")
        End If
    End Sub
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/AP_ComparativoPorCodigoIsinPreciosBonos.aspx','1000','600')</" + "script>"
