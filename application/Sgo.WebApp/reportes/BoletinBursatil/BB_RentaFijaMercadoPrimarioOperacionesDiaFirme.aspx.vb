...
Public Class BB_RentaFijaMercadoSecundarioOperacionesDiaFirme
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookDiario.DocumentName = "BB_RentaFijaMercadoPrimarioOperacionesDiaFirme" & Format(Now(), "dd-MM-yy")
            InstaciaReportSource.ReportDocument = ReportBookDiario
            ReportViewer1.ReportSource = InstaciaReportSource
            ReportViewer1.RefreshReport()
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "BB - Lista de Registro de Operaciones Mercado Primario en FIRME RF", "")
        End If


    End Sub

    Private Sub BB_RentaFijaMercadoPrimarioOperacionesDia_Init(sender As Object, e As EventArgs) Handles Me.Init
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/BB_RentaFijaMercadoPrimarioOperacionesDiaFirme.aspx','1000','600')</" + "script>"
