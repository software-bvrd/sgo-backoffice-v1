...
Public Class BB_RentaFijaMercadoSecundarioOperacionesDia
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookDiario.DocumentName = "BB_RentaFijaMercadoSecundarioOperacionesDia" & Format(Now(), "dd-MM-yy")
            InstaciaReportSource.ReportDocument = ReportBookDiario
            ReportViewer1.ReportSource = InstaciaReportSource
            ReportViewer1.RefreshReport()
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "BB - Mercado Secundario Operaciones del día RF", "")
        End If
    End Sub


    Private Sub BB_RentaFijaMercadoSecundarioOperacionesDia_Init(sender As Object, e As EventArgs) Handles Me.Init
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/BB_RentaFijaMercadoSecundarioOperacionesDia.aspx','1000','600')</" + "script>"
