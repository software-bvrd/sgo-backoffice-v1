...
Public Class BB_RentaFijaVolumenTransadoInstrumentosEntidadesEmisorasMP
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookDiario.DocumentName = "BB_RentaFijaVolumenTransadoInstrumentosEntidadesEmisorasMP" & Format(Now(), "dd-MM-yy")
            InstaciaReportSource.ReportDocument = ReportBookDiario
            ReportViewer1.ReportSource = InstaciaReportSource
            ReportViewer1.RefreshReport()
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "BB - Renta FijaVolumen TransadoInstrumentos Entidades Emisoras MP", "")
        End If
    End Sub
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/BB_RentaFijaVolumenTransadoInstrumentosEntidadesEmisorasMP.aspx','1000','600')</" + "script>"
