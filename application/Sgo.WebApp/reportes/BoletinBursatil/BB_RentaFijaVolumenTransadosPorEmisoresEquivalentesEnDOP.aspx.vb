...
Public Class BB_RentaFijaVolumenTransadosPorEmisoresEquivalentesEnDOP
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookDiario.DocumentName = "BB_RentaFijaVolumenTransadosPorEmisoresEquivalentesEnDOP" & Format(Now(), "dd-MM-yy")
            InstaciaReportSource.ReportDocument = ReportBookDiario
            ReportViewer1.ReportSource = InstaciaReportSource
            ReportViewer1.RefreshReport()
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "BB - Volúmenes Transados por Emisores Equivalentes en DOP RF", "")
        End If
    End Sub
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/BB_RentaFijaVolumenTransadosPorEmisoresEquivalentesEnDOP.aspx','1000','600')</" + "script>"
