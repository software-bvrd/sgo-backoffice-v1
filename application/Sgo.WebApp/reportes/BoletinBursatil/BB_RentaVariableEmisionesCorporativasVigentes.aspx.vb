...
Public Class BB_RentaVariableEmisionesCorporativasVigentes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookDiario.DocumentName = "BB_RentaVariableEmisionesCorporativasVigentes" & Format(Now(), "dd-MM-yy")
            InstaciaReportSource.ReportDocument = ReportBookDiario
            ReportViewer1.ReportSource = InstaciaReportSource
            ReportViewer1.RefreshReport()
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "BB - Emisiones Corporativas Vigentes RV", "")
        End If
    End Sub

    Private Sub BB_RentaVariableEmisionesCorporativasVigentes_Init(sender As Object, e As EventArgs) Handles Me.Init
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/BB_RentaVariableEmisionesCorporativasVigentes.aspx','1000','600')</" + "script>"
