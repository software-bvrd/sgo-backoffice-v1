...
Public Class BB_RentaVariablePreciosdeCierredeldiaporInstrumento
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookDiario.DocumentName = "BB_RentaVariablePreciosdeCierredeldiaporInstrumento" & Format(Now(), "dd-MM-yy")
            InstaciaReportSource.ReportDocument = ReportBookDiario
            ReportViewer1.ReportSource = InstaciaReportSource
            ReportViewer1.RefreshReport()
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "BB - Precios de Cierre del día por Rueda RV", "")
        End If
    End Sub

    Private Sub BB_RentaVariablePreciosdeCierredeldiaporInstrumento_Init(sender As Object, e As EventArgs) Handles Me.Init
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/BB_RentaVariablePreciosdeCierredeldiaporInstrumento.aspx','1000','600')</" + "script>"
