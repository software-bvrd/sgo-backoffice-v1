...
Public Class BB_ResumenGeneralMercado
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookDiario.DocumentName = "BB_ResumenGeneralMercado" & Format(Now(), "dd-MM-yy")
            InstaciaReportSource.ReportDocument = ReportBookDiario
            ReportViewer1.ReportSource = InstaciaReportSource
            ReportViewer1.RefreshReport()
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "BB - Resumen General Mercado", "")
        End If
    End Sub
    ...
    Private Sub BB_ResumenGeneralMercado_Init(sender As Object, e As EventArgs) Handles Me.Init
