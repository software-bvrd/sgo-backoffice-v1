...
Partial Class ReporteComisionNuevoEmisor
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            instanceReportSource.ReportDocument = New MyReportLib.ComisionesRegistroNuevoEmisor

            instanceReportSource.ReportDocument.DocumentName = "Comisiones Registro Nuevo Emisor"

            ReportViewer1.ReportSource = instanceReportSource
            ReportViewer1.RefreshReport()

            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Comisiones Registro Nuevo Emisor", "")
