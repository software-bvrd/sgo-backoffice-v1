<%@ Page Language="VB" AutoEventWireup="false" Inherits="Sgo.WebApp.RptOperacionesPorPuntaMSParticipanteSIMV" Codebehind="RptOperacionesPorPuntaMSParticipanteSIMV.aspx.vb" %>
...
<head id="Head1" runat="server">
    <title>Detalles Comisión Operaciones por Punta MS Participante</title>
            ...
            <telerik:RadScriptManager ID="RadScriptManager1" runat="server"></telerik:RadScriptManager>
                ...
                Width="100%" ViewMode="PrintPreview">
                   ...
                   <Resources CurrentPageToolTip="Página Actual" ExportButtonText="Exportar"
                    ...
                    ParametersToolTip="Clic aquí para abrir el area de parámetros|Clic aquí para cerrar el area de parámetros" 
                    TogglePageLayoutToolTip="Cambiar a  modalidad interactiva|Cambiar a modalidad de Vista Previa" 
                    ZoomToPageWidth="Ancho Página" SessionHasExpiredError="La sesión ha expirado" 
                   SessionHasExpiredMessage="Por favor, actualice la página." ReportParametersSelectAValueText="<seleccionar un valor>"></Resources>
