...
Partial Class ComparativoVolumenesBonos
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookDiario.Reports.Add(New MyReportLib.ComparativoVolumenesBonos)


            ReportBookDiario.DocumentName = "ComparativoVolumenesBonos" & Format(Now(), "dd-MM-yy")
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        If e.Item.Value = 7 Then 'Mover
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/ComparativoVolumenesBonos.aspx','1000','600')</" + "script>"
