...
Public Class ReportONE
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookONE.DocumentName = "REP ONE " & Format(Now(), "dd-MM-yyyy")
            ...
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Reporte Oficina Nacional de Estadística (ONE)", "")
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        ...
        If e.Item.Value = 7 Then 'Mover
            ...
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/ReportONE.aspx','1000','600')</" + "script>"
