...
Partial Class ReporteCalificacionesRiesgo
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            instanceReportSource.ReportDocument = New MyReportLib.CalificacionesDeRiesgo

            instanceReportSource.ReportDocument.DocumentName = "Calificaciones De Riesgo"

            ReportViewer1.ReportSource = instanceReportSource
            ReportViewer1.RefreshReport()

            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "CalificacionesDeRiesgo", "")
        End If
    End Sub
