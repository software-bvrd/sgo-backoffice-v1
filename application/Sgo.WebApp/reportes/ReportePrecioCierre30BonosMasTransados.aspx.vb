...
Partial Class ReportePrecioCierre30BonosMasTransados
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ReportBookDiario.Reports.Add(New MyReportLib.PrecioCierre30BonosMasTransados)

            InstaciaReportSource.ReportDocument = ReportBookDiario

            ReportBookDiario.DocumentName = "Precios de Cierre de los bonos transados"

            ReportViewer1.ReportSource = InstaciaReportSource
            ReportViewer1.RefreshReport()

            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Precios de Cierre de los bonos transados", "")
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        ...
        If e.Item.Value = 7 Then 'Mover
            ...
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/ReportePrecioCierre30BonosMasTransados.aspx','1000','600')</" + "script>"
