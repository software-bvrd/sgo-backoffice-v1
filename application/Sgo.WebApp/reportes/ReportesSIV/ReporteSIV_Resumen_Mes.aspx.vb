...
Public Class ReporteSIV_Resumen_Mes
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            instanceReportSource.ReportDocument = New MyReportLib.ReporteSIV_Resumen


            instanceReportSource.ReportDocument.DocumentName = "Resumen Mes"
            ...
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Reporte SIV Resumen Mensual", "")
