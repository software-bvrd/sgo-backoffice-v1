...
Public Class ReporteSIV_Resumen_Trimestre
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            instanceReportSource.ReportDocument.DocumentName = "Resumen Mes-Trim"
            ...
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Reporte SIV Resumen Trimestre", "")
