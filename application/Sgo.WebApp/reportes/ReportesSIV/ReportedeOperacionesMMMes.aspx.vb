...
Public Class ReportedeOperacionesMMMes
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            instanceReportSource.ReportDocument.DocumentName = "MM MES"
            ...
            instanceReportSource.ReportDocument.ReportParameters(3).Value = "|33|"
            instanceReportSource.ReportDocument.ReportParameters(4).Value = "Market Makers MH"

            ReportViewer1.ReportSource = instanceReportSource
            ReportViewer1.RefreshReport()

            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Reporte de Operaciones MM Mes", "")
