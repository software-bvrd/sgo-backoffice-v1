...
Public Class ReportedeOperacionesMMTrimestre
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            instanceReportSource.ReportDocument.DocumentName = "MM TRIM"
            ...
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Reporte de Operaciones MM Trimestre", "")
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        ...
        If e.Item.Value = 7 Then 'Mover
            ...
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/ReportesSIV/ReportedeOperacionesMMTrimestre.aspx','1000','600')</" + "script>"
