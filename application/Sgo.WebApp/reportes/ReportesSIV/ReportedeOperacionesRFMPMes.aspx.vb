...
Public Class ReportedeOperacionesRFMPMes
 ...
 Dim oper As New operation
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            instanceReportSource.ReportDocument.DocumentName = "RF MP MES"
            ...
            instanceReportSource.ReportDocument.ReportParameters(3).Value = "|23|"
            instanceReportSource.ReportDocument.ReportParameters(4).Value = "Renta Fija Mercado Primario"

            ReportViewer1.ReportSource = instanceReportSource
            ReportViewer1.RefreshReport()

            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Reporte de Operaciones RF MP Mes", "")
