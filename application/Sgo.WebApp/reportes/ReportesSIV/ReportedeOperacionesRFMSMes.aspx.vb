...
Public Class ReportedeOperacionesRFMSMes
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            instanceReportSource.ReportDocument.DocumentName = "RF MS MES"
            ...
            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Reporte de Operaciones RF MS Mes", "")
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        ...
        If e.Item.Value = 7 Then 'Mover
            ...
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/ReportesSIV/ReportedeOperacionesRFMSMes.aspx','1000','600')</" + "script>"
