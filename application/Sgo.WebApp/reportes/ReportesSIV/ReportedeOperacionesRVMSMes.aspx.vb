...
Public Class ReportedeOperacionesRVMSMes
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            instanceReportSource.ReportDocument.DocumentName = "RV MS MES"
            ...
            instanceReportSource.ReportDocument.ReportParameters(3).Value = "|37|"
            instanceReportSource.ReportDocument.ReportParameters(4).Value = "Renta Variable Mercado Secundario"

            ReportViewer1.ReportSource = instanceReportSource
            ReportViewer1.RefreshReport()

            oper.GenerarSeguimientoActividadUsuario(Session("IdUsuario"), "Ingreso a Reporte", "Reporte de Operaciones RV MS Mes", "")
    ...
    Protected Sub RadToolBar1_ButtonClick(sender As Object, e As RadToolBarEventArgs) Handles RadToolBar1.ButtonClick
        ...
        If e.Item.Value = 7 Then 'Mover
            ...
            InjectScriptLabelImprimir.Text = "<script>ventanaSecundaria('../reportes/ReportesSIV/ReportedeOperacionesRVMSMes.aspx','1000','600')</" + "script>"
